...
class ImageToImage2D(Dataset):
    ...
    def __init__(self, dataset_path: str, split: str, joint_transform: Callable = None, img_size=256, prompt = "click", class_id=1,
    ...
    def __getitem__(self, i):
        ...
        if "test" in self.split:
            ...
            class_id0, sub_path, filename = id_.split('/')[0], id_.split('/')[1], id_.split('/')[2]
            #print(class_id0, sub_path, filename)
        ...
        mask = np.where(mask is None, 0, mask)
        classes = 2 #self.class_dict[sub_path]
        if classes == 2:
            mask[mask > 1] = 1
